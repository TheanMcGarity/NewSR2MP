...
namespace Mirror
{
    public class SyncList<T> : SyncObject, IList<T>, IReadOnlyList<T>
    {
        ...
        /// <summary>
        /// This is called for all changes to the Il2CppSystem.Collections.Generic.List.
        ...
        /// <summary>This is called before the Il2CppSystem.Collections.Generic.List is cleared so the Il2CppSystem.Collections.Generic.List can be iterated</summary>
        ...
        // Il2CppSystem.Collections.Generic.List of changes.
        // -> insert/delete/clear is only ONE change
        // -> changing the same slot 10x caues 10 changes.
        // -> note that this grows until next sync(!)
        readonly Il2CppSystem.Collections.Generic.List<Change> changes = new Il2CppSystem.Collections.Generic.List<Change>();

        // how many changes we need to ignore
        // this is needed because when we initialize the Il2CppSystem.Collections.Generic.List,
        ...
        public SyncList(IEqualityComparer<T> comparer)
        {
            ...
            objects = new Il2CppSystem.Collections.Generic.List<T>();
        }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            // if init,  write the full Il2CppSystem.Collections.Generic.List content
        ...
        public override void OnDeserializeAll(NetworkReader reader)
        {
            ...
            // the next time the Il2CppSystem.Collections.Generic.List is synchronized
                ...
                switch (operation)
                {
                    ...
                    case Operation.OP_CLEAR:
                        if (apply)
                        {
                            ...
                            // clear after invoking the callback so users can iterate the Il2CppSystem.Collections.Generic.List
        ...
        public Il2CppSystem.Collections.Generic.List<T> FindAll(Predicate<T> match)
        {
            Il2CppSystem.Collections.Generic.List<T> results = new Il2CppSystem.Collections.Generic.List<T>();
            for (int i = 0; i < objects.Count; ++i)
                if (match(objects[i]))
        ...
        {
            Il2CppSystem.Collections.Generic.List<T> toRemove = new Il2CppSystem.Collections.Generic.List<T>();
            for (int i = 0; i < objects.Count; ++i)
                if (match(objects[i]))
        ...
        {
            readonly SyncList<T> Il2CppSystem.Collections.Generic.List;
            int index;

            public T Current { get; private set; }

            public Enumerator(SyncList<T> Il2CppSystem.Collections.Generic.List)
            {
                this.list = Il2CppSystem.Collections.Generic.List;
                index = -1;
                Current = default;
            }
            ...
            {
                if (++index >= Il2CppSystem.Collections.Generic.List.Count)
                    return false;

                Current = Il2CppSystem.Collections.Generic.List[index];
                return true;
            }
