...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        public Il2CppSystem.Collections.Generic.List<GameObject> spawnPrefabs = new Il2CppSystem.Collections.Generic.List<GameObject>();

        /// <summary>List of transforms populated by NetworkStartPositions</summary>
        public static Il2CppSystem.Collections.Generic.List<Transform> startPositions = new Il2CppSystem.Collections.Generic.List<Transform>();
...
#pragma warning restore 618
            ...
            {
                Debug.LogWarning("NetworkManager - Player Prefab doesn't need to be in Spawnable Prefabs Il2CppSystem.Collections.Generic.List too. Removing it.");
        ...
        void SetupServer()
        {
            ...
            if (authenticator != null)
            {
                ...
                authenticator.OnServerAuthenticated.AddListener(new System.Action<Mirror.NetworkConnectionToClient>(OnServerAuthenticated));
            }
        ...
        /// <summary>Starts the server, Il2CppSystem.Collections.Generic.Listening for incoming connections.</summary>
        public void StartServer()
        {
            ...
            //   Il2CppSystem.Collections.Generic.Listen
            //   if onlineScene:
            //       LoadSceneAsync
            //       ...
            ...
            // call OnStartServer AFTER Il2CppSystem.Collections.Generic.Listen, so that NetworkServer.active is
            // true and we can call NetworkServer.Spawn in OnStartServer
            // overrides.
            // (useful for loading & spawning stuff from database etc.)
            //
            // note: there is no risk of someone connecting after Il2CppSystem.Collections.Generic.Listen() and
...
#pragma warning restore 618
        ...
        void FinishStartHost()
        {
            ...
            //
            // TODO is there a risk of someone connecting between Il2CppSystem.Collections.Generic.Listen() and FinishStartHost()?
            OnStartServer();
        ...
        /// <summary>Stops the server from Il2CppSystem.Collections.Generic.Listening and simulating the game.</summary>
        public void StopServer()
        {
            ...
            if (authenticator != null)
            {
                authenticator.OnServerAuthenticated.RemoveListener(new System.Action<NetworkConnectionToClient>(OnServerAuthenticated));
