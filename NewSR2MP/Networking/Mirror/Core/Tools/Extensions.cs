...
namespace Mirror
{
    public static class Extensions
    {
        ...
        // helper function to copy to Il2CppSystem.Collections.Generic.List<T>
        // C# only provides CopyTo(T[])
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void CopyTo<T>(this Il2CppSystem.Collections.Generic.IEnumerable<T> source, Il2CppSystem.Collections.Generic.List<T> destination)
        {
