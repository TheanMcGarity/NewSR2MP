...
namespace Mirror
{
    ...
    {
        // removes the first 'amount' elements from the sorted Il2CppSystem.Collections.Generic.List
    ...
    public static class SnapshotInterpolation
    {
        ...
        // adds / inserts it to the Il2CppSystem.Collections.Generic.List & initializes local time if needed.
